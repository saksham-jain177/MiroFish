...
class GraphBuilderService:
    ...
    def _wait_for_episodes(
        ...
        if progress_callback:
            progress_callback(f" {total_episodes} ...", 0)
        ...
        while pending_episodes:
            ...
            if progress_callback:
                progress_callback(
                    f"Zep... {completed_count}/{total_episodes} , {len(pending_episodes)}  ({elapsed})",
        ...
        if progress_callback:
            progress_callback(f": {completed_count}/{total_episodes}", 1.0)
