    ...
    try:
        ...
        return jsonify({
            ...
            "data": {
                ...
                "task_id": task_id,
                "status": "preparing",
                "message": "， /api/simulation/prepare/status ",
            ...
            if simulation_id:
                return jsonify({
                    ...
                    "data": {
                        ...
                        "status": "not_started",
                        "progress": 0,
                        "message": "， /api/simulation/prepare ",
                        "already_prepared": False
                    }
                })
            return jsonify({
...
def download_simulation_script(script_name: str):
    ...
    try:
        ...
        if script_name not in allowed_scripts:
            return jsonify({
                "success": False,
                "error": f": {script_name}，: {allowed_scripts}"
            }), 400
...
def start_simulation():
    ...
    try:
        ...
        if platform not in ['twitter', 'reddit', 'parallel']:
            return jsonify({
                "success": False,
                "error": f": {platform}，: twitter/reddit/parallel"
            }), 400
        ...
        if state.status != SimulationStatus.READY:
            ...
            if is_prepared:
                ...
                return jsonify({
                    "success": False,
                    "error": f"，: {state.status.value}， /prepare "
                }), 400
    ...
    try:
        ...
        for i, interview in enumerate(interviews):
            ...
            if item_platform and item_platform not in ("twitter", "reddit"):
                return jsonify({
                    "success": False,
                    "error": f"{i+1}platform 'twitter'  'reddit'"
                }), 400
