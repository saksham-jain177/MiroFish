    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 0" class="badge success"></span>
            <span v-else class="badge processing"></span>
          </div>
        </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title"> Agent </span>
          </div>
          <div class="step-status">
            <span v-if="phase > 1" class="badge success"></span>
        ...
        <div class="card-content">
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title"> Agent </span>
            </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 2" class="badge success"></span>
            <span v-else-if="phase === 2" class="badge processing"></span>
            <span v-else class="badge pending"></span>
          </div>
        </div>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Agent </span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title"></span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name"> 1： / </span>
                  </div>
                ...
                <div v-if="simulationConfig.reddit_config" class="platform-card">
                  <div class="platform-card-header">
                    <span class="platform-name"> 2： / </span>
                  </div>
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label"></span>
            ...
            <div v-if="simulationConfig.generation_reasoning" class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">LLM </span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 3" class="badge success"></span>
            <span v-else-if="phase === 3" class="badge processing"></span>
            <span v-else class="badge pending"></span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <div v-if="simulationConfig?.event_config" class="orchestration-content">
            ...
            <div class="initial-posts-section">
              <span class="box-label"> ({{ simulationConfig.event_config.initial_posts.length }})</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase >= 4" class="badge processing"></span>
            <span v-else class="badge pending"></span>
          </div>
        </div>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish  <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> ， <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> </span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>Agent100： {{ Math.round(customMaxRounds * 0.6) }} </span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        Agent100： {{ Math.round(autoGeneratedRounds * 0.6) }} 
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">，‘’， ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            ...
            <div class="info-item">
              <span class="info-label"></span>
              <span class="info-value">{{ { male: '', female: '', other: '' }[selectedProfile.gender] || selectedProfile.gender }}</span>
            </div>
            <div class="info-item">
              <span class="info-label">/</span>
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`，: ${customMaxRounds.value} `)
  } else {
    addLog(`，: ${autoGeneratedRounds.value} `)
  }
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (res.data.expected_entities_count) {
        ...
        addLog(`Zep ${res.data.expected_entities_count} `)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        addLog(`→ Agent ${currentCount}/${total}: ${profileName} (${latestProfile?.profession || ''})`)
        
        if (expectedTotal.value && currentCount >= expectedTotal.value) {
          addLog(`✓  ${currentCount} Agent`)
        }
      }
    }
  } catch (err) {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          addLog(`  ├─ Agent: ${data.summary.total_agents}`)
          addLog(`  ├─ : ${data.summary.simulation_hours}`)
          addLog(`  ├─ : ${data.summary.initial_posts_count}`)
          addLog(`  ├─ : ${data.summary.hot_topics_count}`)
          addLog(`  └─ : Twitter ${data.summary.has_twitter_config ? '✓' : '✗'}, Reddit ${data.summary.has_reddit_config ? '✓' : '✗'}`)
        }
        
        if (data.config.time_config) {
          const tc = data.config.time_config
          addLog(`: ${tc.minutes_per_round}, ${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)}`)
        }
...
const loadPreparedData = async () => {
  ...
  addLog(` ${profiles.value.length} Agent`)
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        if (res.data.summary) {
          addLog(`  ├─ Agent: ${res.data.summary.total_agents}`)
          addLog(`  ├─ : ${res.data.summary.simulation_hours}`)
