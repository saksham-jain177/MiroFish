    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 0" class="badge success"></span>
            <span v-else-if="currentPhase === 0" class="badge processing"></span>
        ...
        <div class="card-content">
          ...
          <div v-if="currentPhase === 0 && ontologyProgress" class="progress-section">
            ...
            <span>{{ ontologyProgress.message || '...' }}</span>
          </div>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">GraphRAG</span>
          </div>
          <div class="step-status">
            <span v-if="currentPhase > 1" class="badge success"></span>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase >= 2" class="badge accent"></span>
          </div>
        </div>
