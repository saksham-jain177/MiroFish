            ...
            >
              ...
              <div class="section-body" v-show="!collapsedSections.has(idx)">
                ...
                <div v-else-if="currentSectionIndex === idx + 1" class="loading-state">
                  ...
                  <span class="loading-text">{{ section.title }}...</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">， 4 ，MiroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">，Global/Local Memory，</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc"> GraphRAG ，，</div>
                  </div>
                </div>
            ...
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || '' }}</span>
                </div>
              </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? ' Report Agent ，' : '，' }}
              </p>
            </div>
            <div 
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              ...
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || '' }}</span>
                  </div>
              ...
              <div class="selection-actions">
                ...
                <button class="action-link" @click="clearAgentSelection"></button>
              </div>
            </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              <span class="results-title"></span>
              <span class="results-count">{{ surveyResults.length }} </span>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || '' }}</span>
                  </div>
                </div>
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    if (responseContent) {
      ...
      addLog(`${selectedAgent.value.username} `)
    } else {
      throw new Error('')
    }
  } else {
...
const submitSurvey = async () => {
  ...
  addLog(` ${selectedAgents.value.size} ...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(` ${surveyResults.value.length} `)
    } else {
      throw new Error(res.error || '')
    }
  } catch (err) {
